...
function CreateInvoice({ openCreateInvoice, setOpenCreateInvoice, invoice, type }) {
    ...
    const onSubmit = async() => {
        ...
        if (type === 'edit') {
            ...
            item.map((a)=>{
                name.push(a.name);
                price.push(parseInt(a.total));
                quantity.push(a.quantity);
            })
            await createInvoice(name,quantity,price,clientName,clientEmail,selectDeliveryDate.toString())
            console.log("data",selectDeliveryDate.toString());
            setOpenCreateInvoice(false)
        ...
        <div onClick={(e) => {
            ...
            >
                ...
                <div className=' overflow-y-scroll scrollbar-hide my-14'>
                    ...
                    <h1 className=' text-[#7c5dfa] my-1 mt-0.5 font-medium'>
                        Bill To
                    </h1>
